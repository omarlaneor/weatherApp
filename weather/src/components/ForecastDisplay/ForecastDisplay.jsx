...
function ForecastDisplay({ forecastData, keys }) {
  return (
    <section className="p-8 md:p-0 md:pb-10 grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-7">
      {keys.slice(0, 5).map((day) => {
        ...
        return (
          <article
            className="flex flex-col items-center bg-blue-1 py-10 px-4 m-auto"
            key={day}
          >
